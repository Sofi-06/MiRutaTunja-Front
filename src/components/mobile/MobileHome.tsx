...
const styles = StyleSheet.create({
  page: { flex: 1, backgroundColor: '#f4f8fa' }, content: { paddingBottom: 88 }, hero: { height: 282, overflow: 'hidden', paddingHorizontal: 20, borderBottomLeftRadius: 38, borderBottomRightRadius: 38 }, heroImage: { resizeMode: 'cover' }, heroShade: { ...StyleSheet.absoluteFill, backgroundColor: 'rgba(238,247,251,0.78)' },
